...
**새 프로젝트에 처음 도입할 때 먼저 볼 것 (대략 이 순서)**: 아래 목록
대신 0단계부터 순서대로 실행하는 체크리스트가 필요하면
[GETTING-STARTED.md](GETTING-STARTED.md)를 바로 봐도 된다.
...
- [GETTING-STARTED.md](GETTING-STARTED.md) — 내 프로젝트에 처음 도입할 때
  0단계부터 순서대로 실행하는 단계별 절차.
